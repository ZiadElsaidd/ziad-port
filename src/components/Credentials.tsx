...
const FLOAT_WORDS = [
  'Certified', 'Verified', '2026', 'Architecture',
  'Manara Academy', '2026', 'Zidio', 'Full Stack',
...
const CERTIFICATIONS = [
  {
    ...
    issuer: 'Manara Academy',
    year: '2026',
    file: '/certificates/Frontend Engineering With React.jpeg',
  },
  {
    num: '02',
    title: 'Backend Engineering With NodeJS',
    issuer: 'Manara Academy',
    year: '2026',
    file: '/certificates/Backend Engineering With NodeJS.jpeg',
  },
];
...
function ContribGrid({ contributions }: { contributions: GHDay[] }) {
  ...
  return (
    <div className="flex gap-0.75 overflow-hidden w-full">
      {weeks.map((wk, wi) => (
        <div key={wi} className="flex flex-col gap-0.75 flex-1 min-w-0">
          {wk.map((day, di) => (
            <div
              key={di}
    ...
    >
      ...
      >
        ...
        <div className="flex items-center justify-between px-6 py-5 border-b border-white/8">
          ...
          <a
            href="https://github.com/ZiadElsaidd"
            target="_blank"
      ...
      <div className="relative z-10 max-w-360 mx-auto px-[clamp(1.25rem,5vw,5rem)] py-[clamp(5rem,10vw,11rem)]">
        ...
        >
          ...
          <div className="relative flex flex-col lg:flex-row lg:items-end justify-between gap-10 lg:gap-16">
            ...
            >
              <MagneticBtn href="/resume/Ziad Elsaid.pdf" />
            </motion.div>
          </div>
