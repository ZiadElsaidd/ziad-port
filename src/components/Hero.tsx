  ...
  return (
    ...
    >
      ...
      <div className="absolute inset-0 z-0 pointer-events-none overflow-hidden">
        <Image alt="" src="/1.png" fill className="object-cover" />
      ...
      <div className="relative z-10 flex flex-col flex-1 w-full pl-[clamp(1rem,4vw,5rem)] pr-[clamp(1rem,8vw,14rem)]">
        ...
        <div className="flex flex-col flex-1 justify-end pb-[clamp(2.5rem,6vw,6rem)]">
          ...
          >
            <span ref={line1Ref} className="block cursor-default select-none">Ziad</span>
            <span ref={line2Ref} className="block cursor-default select-none">Elsaid</span>
          </h1>
