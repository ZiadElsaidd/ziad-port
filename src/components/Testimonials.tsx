...
const TESTIMONIALS: Testimonial[] = [
  ...
  },
  {
    ...
    company: 'Endorsement · LinkedIn',
    quote:
      'Ziad Elsaid possesses an in-depth understanding of Python, consistently delivering high-quality code with a keen eye for detail. A great team player who communicates effectively — I wholeheartedly endorse him.',
...
export function Testimonials() {
  ...
  return (
    ...
    >
      ...
      <motion.div
        aria-hidden
        className="absolute -top-32 -left-32 w-160 h-160 rounded-full pointer-events-none"
      ...
      <motion.div
        aria-hidden
        className="absolute -bottom-40 -right-24 w-xl h-xl rounded-full pointer-events-none"
      ...
      <div className="relative z-10 max-w-360 mx-auto px-[clamp(1.25rem,5vw,5rem)] py-[clamp(5rem,10vw,11rem)]">
        ...
        >
          ...
          <div className="relative order-1 lg:order-2">
            ...
            <div className="relative w-full aspect-4/5 sm:aspect-square bg-white/2 border border-white/10 overflow-hidden">
              <AnimatePresence mode="wait" custom={dir}>
                <motion.div
                  key={active}
